...
def generateDatabase(dataset_path):
    ...
    for subset in subsets:
        if subset in classes:
            ...
            annotations = images + [os.path.join(subset_annotations_path,file) for file in os.listdir(subset_annotations_path) if 'xml' in file]
            images = images + [os.path.join(subset_images_path,file) for file in os.listdir(subset_images_path) if 'jpg' in file or 'png' in file]
...
generateDatabase('/mnt/d/Empresas/Wasys/databases/mesa')

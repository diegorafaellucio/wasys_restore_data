...
def convert_annotation(input_file, output_file, subset):
...
def generate_labels(dataset_path):
    ...
    for subset in subsets:
        ...
        if subset in classes:
            ...
            class_path = os.path.join(dataset_path, subset)
            ...
            for annotation in annotations:
                if 'xml' in annotation:
                    ...
                    convert_annotation(annotation_xml, annotation_txt, subset)
